...
static const struct qmp_ufs_init_tbl sxr2250_ufsphy_serdes[] = {
	...
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_VCO_TUNE_INITVAL2, 0x00),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_BIN_VCOCAL_HSCLK_SEL, 0x11),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_DEC_START_MODE0, 0x98),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_CP_CTRL_MODE0, 0x06),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_PLL_RCTRL_MODE0, 0x16),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_PLL_CCTRL_MODE0, 0x36),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_LOCK_CMP1_MODE0, 0x32),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_LOCK_CMP2_MODE0, 0x0F),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_BIN_VCOCAL_CMP_CODE1_MODE0, 0xAC),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_BIN_VCOCAL_CMP_CODE2_MODE0, 0x1E),

	QMP_PHY_INIT_CFG(QSERDES_V5_COM_BG_TIMER, 0x0A),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_CMN_CONFIG, 0x06),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_CLK_SELECT, 0x31),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SYS_CLK_CTRL, 0x02),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_BIAS_EN_CLKBUFLR_EN, 0x14),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_RESETSM_CNTRL, 0x28),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_LOCK_CMP_CFG, 0x00),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_VCO_TUNE_CTRL, 0x00),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_VCO_TUNE_INITVAL1, 0xFF),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_VCO_TUNE1_MODE0, 0x53),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_VCO_TUNE2_MODE0, 0x02),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_VCO_TUNE_TIMER1, 0xFF),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_VCO_TUNE_TIMER2, 0x3F),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_INTEGLOOP_GAIN0_MODE0, 0x3F),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_INTEGLOOP_GAIN1_MODE0, 0x00),
};

static const struct qmp_ufs_init_tbl sxr2250_ufsphy_tx[] = {
	QMP_PHY_INIT_CFG(QSERDES_V5_TX_LANE_MODE_1, 0x05),
	QMP_PHY_INIT_CFG(QSERDES_V5_TX_TRAN_DRVR_EMP_EN, 0x0C),
	QMP_PHY_INIT_CFG(QSERDES_V5_TX_TX_POL_INV, 0x00),
	QMP_PHY_INIT_CFG(QSERDES_V5_TX_PWM_GEAR_1_DIVIDER_BAND0_1, 0x16),
	QMP_PHY_INIT_CFG(QSERDES_V5_TX_PWM_GEAR_1_DIVIDER_BAND2, 0x06),
};
...
static const struct qmp_ufs_init_tbl sxr2250_ufsphy_rx[] = {
	...
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_SIGDET_CNTRL, 0x0F),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_SIGDET_DEGLITCH_CNTRL, 0x1E),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_INTERFACE_MODE, 0x44),
	QMP_PHY_INIT_CFG(QSERDES_V5_RX_RX_BAND, 0x18),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_STEP_SIZE1_MODE1,  0xA),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_STEP_SIZE2_MODE1, 0x4B),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_BIAS_EN_CLKBUFLR_EN, 0xB1),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_POST_DIV, 0x80),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_CLK_ENABLE1, 0x80),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_PLL_RCTRL_MODE1, 0x5B),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_INTEGLOOP_GAIN0_MODE0, 0x06),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_INTEGLOOP_GAIN1_MODE0, 0x4E),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_INTEGLOOP_GAIN0_MODE1, 0x1D),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_STEP_SIZE1_MODE0, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_STEP_SIZE2_MODE0, 0x04),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_VCO_TUNE2_MODE0, 0x00),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_INTEGLOOP_P_PATH_GAIN1, 0x10),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_INTEGLOOP_GAIN1_MODE1, 0xC0),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_INTEGLOOP_P_PATH_GAIN0, 0x00),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SVS_MODE_CLK_SEL, 0xE0),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_DEBUG_BUS0, 0xC8),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_DEBUG_BUS1, 0xC8),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_DEBUG_BUS2, 0x3B),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_DEBUG_BUS3, 0xB1),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_CMN_CONFIG, 0x3B),

	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_ADJ_PER2, 0x0A),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_SSC_PER1, 0x0A),
	QMP_PHY_INIT_CFG(QSERDES_V5_COM_VCO_TUNE1_MODE1, 0x00),
...
static const struct qmp_ufs_init_tbl sxr2250_ufsphy_pcs[] = {
	...
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_LINE_RESET_TIME, 0x1F),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_LINE_RESET_GRANULARITY, 0x00),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_TSYNC_RSYNC_CNTL, 0x2A),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_RX_SYM_RESYNC_CTRL, 0x03),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_TX_LARGE_AMP_POST_EMP_LVL, 0x00),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_TX_SMALL_AMP_POST_EMP_LVL, 0x00),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_CFG_CHANGE_CNT_VAL, 0x64),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_RX_SYNC_WAIT_TIME, 0x30),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_TX_PWMGEAR_CAPABILITY, 0x04),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_RX_PWMGEAR_CAPABILITY, 0x04),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_RX_MIN_SLEEP_NOCONFIG_TIME_CAPABILITY, 0x08),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_RX_MIN_STALL_NOCONFIG_TIME_CAPABILITY, 0x0F),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_RX_MIN_SAVE_CONFIG_TIME_CAPABILITY, 0xFA),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_RX_HS_G1_SYNC_LENGTH_CAPABILITY, 0x48),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_RX_LS_PREPARE_LENGTH_CAPABILITY, 0x0A),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_RX_PWM_BURST_CLOSURE_LENGTH_CAPABILITY, 0x1C),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_RX_MIN_ACTIVATETIME_CAPABILITY, 0x01),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_LINECFG_DISABLE, 0x00),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_RX_MIN_HIBERN8_TIME, 0x1C),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_RX_PWM_GEAR_BAND, 0x15),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_LINECFG_HIGHZ_COUNT_CTRL, 0x00),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_LINECFG_HIGHZ_COUNT_INIT_G1, 0x69),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_LINECFG_HIGHZ_COUNT_INIT_G3, 0x1E),
	QMP_PHY_INIT_CFG(QPHY_V5_PCS_UFS_LINECFG_HIGHZ_COUNT_INIT_G4, 0x0F),
};
...
static const char * const sxr2250_ufs_phy_clk_l[] = {
	"ref_clk", "ref_aux_clk", "qref_clk",
};
...
static const struct qmp_ufs_cfg sxr2250_ufsphy_cfg = {
	.lanes			= 2,

	.offsets		= &qmp_ufs_offsets,

	.tbls = {
		.serdes		= sxr2250_ufsphy_serdes,
		.serdes_num	= ARRAY_SIZE(sxr2250_ufsphy_serdes),
		.tx		= sxr2250_ufsphy_tx,
		.tx_num		= ARRAY_SIZE(sxr2250_ufsphy_tx),
		.rx		= sxr2250_ufsphy_rx,
		.rx_num		= ARRAY_SIZE(sxr2250_ufsphy_rx),
...
static const struct udevice_id qmp_ufs_ids[] = {
	...
	{ .compatible = "qcom,sxr2250-qmp-ufs-phy", .data = (ulong)&sxr2250_ufsphy_cfg, },
	{ }
};
